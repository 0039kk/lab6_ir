...
MiniCParser::PrimaryExpContext* MiniCParser::PrimaryExprContext::primaryExp() {
  return getRuleContext<MiniCParser::PrimaryExpContext>(0);
}

MiniCParser::PrimaryExprContext::PrimaryExprContext(UnaryExpContext *ctx) { copyFrom(ctx); }


std::any MiniCParser::PrimaryExprContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<MiniCVisitor*>(visitor))
...
tree::TerminalNode* MiniCParser::NegativeExprContext::T_SUB() {
  return getToken(MiniCParser::T_SUB, 0);
}

MiniCParser::UnaryExpContext* MiniCParser::NegativeExprContext::unaryExp() {
  return getRuleContext<MiniCParser::UnaryExpContext>(0);
}

MiniCParser::NegativeExprContext::NegativeExprContext(UnaryExpContext *ctx) { copyFrom(ctx); }


std::any MiniCParser::NegativeExprContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<MiniCVisitor*>(visitor))
...
tree::TerminalNode* MiniCParser::FunctionCallExprContext::T_ID() {
  return getToken(MiniCParser::T_ID, 0);
}

tree::TerminalNode* MiniCParser::FunctionCallExprContext::T_L_PAREN() {
  return getToken(MiniCParser::T_L_PAREN, 0);
}

tree::TerminalNode* MiniCParser::FunctionCallExprContext::T_R_PAREN() {
  return getToken(MiniCParser::T_R_PAREN, 0);
}

MiniCParser::RealParamListContext* MiniCParser::FunctionCallExprContext::realParamList() {
  return getRuleContext<MiniCParser::RealParamListContext>(0);
}

MiniCParser::FunctionCallExprContext::FunctionCallExprContext(UnaryExpContext *ctx) { copyFrom(ctx); }


std::any MiniCParser::FunctionCallExprContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<MiniCVisitor*>(visitor))
...
MiniCParser::UnaryExpContext* MiniCParser::unaryExp() {
  ...
  try {
    ...
    case 1: {
      _localctx = _tracker.createInstance<MiniCParser::NegativeExprContext>(_localctx);
      enterOuterAlt(_localctx, 1);
      setState(121);
    ...
    case 2: {
      _localctx = _tracker.createInstance<MiniCParser::PrimaryExprContext>(_localctx);
      enterOuterAlt(_localctx, 2);
      setState(123);
      primaryExp();
      break;
    ...
    case 3: {
      _localctx = _tracker.createInstance<MiniCParser::FunctionCallExprContext>(_localctx);
      enterOuterAlt(_localctx, 3);
      setState(124);
      match(MiniCParser::T_ID);
      setState(125);
